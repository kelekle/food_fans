...
public class DishItemAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void addList(List<Result> items) {
    ...
    public void onBindViewHolder(@NonNull final RecyclerView.ViewHolder holder, final int position) {
        ((CourseImageHolder) holder).textView.setText(dataSet.get(position).getName().getTitle());
        Glide.with(context).load(dataSet.get(position).getName().getUrls()).into(((CourseImageHolder)holder).imageView);
