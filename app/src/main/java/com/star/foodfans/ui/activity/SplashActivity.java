...
import com.star.foodfans.util.Session;
...
//        }
    ...
    public void getLogin(){
        ...
        startActivity(intent);
        overridePendingTransition(R.anim.push_up_in, R.anim.push_up_out);
        AppRepository.getAppRepository(SplashActivity.this).selectUserinfoByEmail(Utils.getValue(SplashActivity.this, AppConfig.CURRENT_EMAIL))
